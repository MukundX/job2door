...
//
// Category Modal (select multiple categories)
//
const CategoryModal = ({
  isOpen,
  onClose,
...
//
// Subcategory Modal (select multiple subcategories)
//
...
//
// Dual Range Slider Component for salary range
//
...
// Types for jobs, categories, subcategories
...
export default function SearchClient() {
  ...
  // Fetch education options on mount
  useEffect(() => {
  ...
  // Search function applying all filters
      ...
      if (experience !== "any") {
        if (experience === "fresher") {
          ...
          filteredJobs = filteredJobs.filter(
            job => job.experience_years >= minExp && job.experience_years <= maxExp
          );
        } else {
          filteredJobs = filteredJobs.filter(
  ...
  // Sync filters from URL params on mount or change
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {/* TODO: Add Chips or Filter Tags display area */}
